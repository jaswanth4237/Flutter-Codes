            ...
            children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: const [
                          ...
                          SizedBox(height: 6),
                          Text(
                            "Naturally grown, nutrient-rich organic broccoli. Raised with love by the Standley family for 24 years.",
                            style: TextStyle(
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    final totalPrice = (quantity * 3.29);
                  ...
                  child: Text(
                    "+ Add (\$${(quantity * 3.29).toStringAsFixed(2)})",
                  ),
                ),
              ),
            ],
